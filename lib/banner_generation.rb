module BannerGeneration
  def create_organisation_banner(org_name, org_id)
    ...
    banner = ImageList.new("public/images/organisations/banner.png")
    ...
    gc = Draw.new
    gc.font= "public/images/organisations/Arial_Rounded_Bold.ttf"
    gc.stroke = 'transparent'
    gc.fill = '#63b8c1'
    ...
    gc.annotate(banner, metrics_2.width,metrics_2.height,117+5+metrics.width,82, "Version 1.0")
  
    banner.write("public/images/organisations/#{org_id}.png")
