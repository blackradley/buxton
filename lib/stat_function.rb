...
class StatFunction
  ...
  attr_reader :topics, :hashes 
  def initialize(topics, hashes)
    @topics = topics
    @hashes = hashes
    existing_proposed = StatQuestion.new([@hashes['existing_proposed']['type'], @hashes['existing_proposed']['weight']], "existing_proposed", hashes)
