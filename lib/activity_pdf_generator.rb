...
class ActivityPDFGenerator
  ...
  def build_header
      ...
      @pdf.text "<c:uline><b>Borchester Town Council Analysis Report</b></c:uline>", :justification => :center, :font_size => 14
  ...
  def build_strand_tables
    ...
    @pdf.text " "
    @pdf.text "<b> 3#{'.' + section_index.to_s} <c:uline> Concluding Statement on Full Assessment</b></c:uline> ", :font_size => 12
    @pdf.text " "
