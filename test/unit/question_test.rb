...
class QuestionTest < ActiveSupport::TestCase
  ...
  context "For a select question with a children" do
    setup do
      @activity = Factory.stub(:activity)
      @question = Factory(:question, :input_type => "select", :needed => true, :activity => @activity, :choices => ["Not Answered", "Yes", "No"])
      @child_question = Factory(:question, :input_type => "select", :needed => false, :activity => @activity, :choices => ["Not Answered", "Yes", "No"])
